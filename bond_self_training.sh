...
DATA_ROOT=$PROJECT_ROOT/dataset/bond_jsons_new/
...
# output
OUTPUT=$PROJECT_ROOT/outputs/bond_output/self_training/${MODEL_TYPE}_reinit${REINIT}_begin${BEGIN_STEP}_period${PERIOD}_${LABEL_MODE}_hp${HP_LABEL}_${EPOCH}_${LR}/
